...
- [ ] [006 - Implement view tool for reading files and directories](docs/tasks/active/006-view-tool/spec.md) (Effort: M, Tier: standard)
- [ ] [007 - Implement AskUserQuestion tool with multi-choice support](docs/tasks/active/007-askuserquestion-tool/spec.md) (Effort: M, Tier: standard)
...
- [ ] [030 - Add context section to StatePane](docs/tasks/active/030-statepane-context/spec.md) (Effort: S, Tier: standard)
